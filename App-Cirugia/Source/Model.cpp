...
Model::Model(std::string const& path, std::string const& file_prop, bool gamma) : gammaCorrection(gamma)
{
...
glm::mat4 Model::getModelMatrix() {
    ...
    t = glm::rotate(t, rot_x, glm::vec3(1, 0, 0));
    t = glm::rotate(t, rot_y, glm::vec3(0, 1, 0));
    t = glm::rotate(t, rot_z, glm::vec3(0, 0, 1));
    if (!rotateAnimation) return t;
    float time = glfwGetTime();
    return glm::rotate(t, time * 0.5f, glm::vec3(0, 1, 0));
}

void Model::editPanel() {
    std::string title = "Edit Panel: " + file_prop;

    ImGui::Begin(title.c_str());
    ImGui::SliderFloat("pos X", &x, -500, 500);
    ImGui::SliderFloat("pos Y", &y, -500, 500);
    ImGui::SliderFloat("pos Z", &z, -500, 500);
    ImGui::SliderFloat("Scale factor", &scaleFactor, 0.1, 2);
    ImGui::SliderFloat("rot. X", &rot_x, -3.14 * 2, 3.14 * 2);
    ImGui::SliderFloat("rot. Y", &rot_y, -3.14 * 2, 3.14 * 2);
    ImGui::SliderFloat("rot. Z", &rot_z, -3.14 * 2, 3.14 * 2);
